<!-- resources/views/pages/catatan_imunisasi/create.blade.php -->
...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">
            <i class="bi bi-plus-circle"></i> Tambah Catatan Imunisasi
        </h2>
        <a href="{{ route('admin.catatan-imunisasi.index') }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('admin.catatan-imunisasi.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">
                    <i class="bi bi-file-medical"></i> Form Data Catatan Imunisasi
                </h5>
            </div>
            <div class="card-body">
                <div class="row">
                ...
                <div class="mt-4">
                    <h5 class="mb-3">
                        <i class="bi bi-files"></i> Upload Kartu Imunisasi/Scan Dokumen
                    </h5>
